...
public class ClothesMain {
	...
	public static void main(String[] args) {
		...
		lb1.setFont(new Font("±º∏≤", Font.BOLD, 18));
		lb1.setForeground(Color.WHITE);
		lb1.setBounds(12, 79, 57, 15);
		p1.add(lb1);
		
		JLabel lb2 = new JLabel("\uBE44\uBC00\uBC88\uD638");
		lb2.setFont(new Font("±º∏≤", Font.BOLD, 18));
		...
		b2.setFont(new Font("±º∏≤", Font.BOLD, 16));
		...
		b3.setFont(new Font("±º∏≤", Font.BOLD, 16));
